...
import 'edit_goods_model.dart';

/// 商品追加ページ
class EditGoodsPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<EditGoodsModel>(
      create: (context) => EditGoodsModel(context),
      builder: (context, child) {
        return Consumer<EditGoodsModel>(
          builder: (context, model, child) {
            return DefaultPage<EditGoodsModel>(
              route: kRouteGoodsEdit,
              children: [
                BootstrapRow(
                  height: 0,
                  children: [
